...
public class Constant {
    ...
    public static final String FEEDS_TAB_NEWS2 = "综合新闻";
    public static final String FEEDS_TAB_MEDIA = "媒体成大";
    public static final String FEEDS_TAB_COLOR_CAMPUS = "多彩校园";
    public static final String FEEDS_TAB_ARTICLE = "学术文化";
    public static final String FEEDS_TAB_HQC_ANNOUNCE = "后勤公告";

    public static final String[] FEEDS_TABS = {
            FEEDS_TAB_HQC_ANNOUNCE,
            FEEDS_TAB_ANNOUNCE,
            FEEDS_TAB_COLOR_CAMPUS,
            FEEDS_TAB_MEDIA,
            FEEDS_TAB_ARTICLE,
            FEEDS_TAB_NEWS,
            FEEDS_TAB_NEWS2
